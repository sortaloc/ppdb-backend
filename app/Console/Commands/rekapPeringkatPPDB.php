...
class rekapPeringkatPPDB extends Command
{
    ...
    {
        // 0
        $exe_0_0 = DB::connection('sqlsrv_2')->statement("DROP table rekap.peringkat_ppdb_tahap_1");
                    ...
                    FROM
                        ...
                        SELECT
                            ...
                            SELECT
                                    ROW_NUMBER
                                    () OVER (
                                            PARTITION BY pilihan.sekolah_id
                                    ORDER BY
                                    ...
                                    (CASE 
                                            ...
                                            WHEN pilihan.jalur_id IN ('0300','0500') THEN kuota.kuota_0300
                ...
                -- 			AND ranking_zonasi.urut_dipilih = 1
                        ...
                        SELECT
                            ...
                            WHERE
                                    pilihan.soft_delete = 0 
                                    AND calons.soft_delete = 0 
                                    AND pilihan.jalur_id IN ('0300','0500')
                            ) ranking_sekolah on ranking_sekolah.calon_peserta_didik_id = ppdb.pilihan_sekolah.calon_peserta_didik_id 
                            AND ranking_sekolah.sekolah_id = ppdb.pilihan_sekolah.sekolah_id
                            JOIN (
                            SELECT
        ...
        if($exe_0_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_1 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_1 ...".PHP_EOL;
        }
        if($exe_0_1){
        ...
        // 1
        $exe_1_0 = DB::connection('sqlsrv_2')->statement("DROP table rekap.peringkat_ppdb_tahap_1_masuk");
        $exe_1_1 = DB::connection('sqlsrv_2')->statement("SELECT
                                                        ...
                                                        WHERE 
                                                            status_final = 'MASUK'");
        if($exe_1_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_1_masuk ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_1_masuk ...".PHP_EOL;
        }
        if($exe_1_1){
        ...
        // 2
        $exe_2_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_1_degradasi");
        ...
        if($exe_2_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_1_degradasi ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_1_degradasi ...".PHP_EOL;
        }
        if($exe_2_1){
        ...
        // 3
        $exe_3_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_1_masuk_diambil");
        ...
        if($exe_3_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_1_masuk_diambil ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_1_masuk_diambil ...".PHP_EOL;
        }
        if($exe_3_1){
        ...
        // 4
        $exe_4_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_1_2");
        ...
        if($exe_4_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_1_2 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_1_2 ...".PHP_EOL;
        }
        if($exe_4_1){
        ...
        // 5
        $exe_5_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.sisa_kuota_tahap_1");
        $exe_5_1 = DB::connection('sqlsrv_2')->statement("SELECT
                                                            ...
                                                            (CASE 
                                                                    ...
                                                                    WHEN rekap.peringkat_ppdb_tahap_1_masuk_diambil.jalur_id IN ('0300','0500') THEN kuota.kuota_0300
        ...
        if($exe_5_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.sisa_kuota_tahap_1 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.sisa_kuota_tahap_1 ...".PHP_EOL;
        }
        if($exe_5_1){
        ...
        // 6
        $exe_6_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_2_masuk");
        ...
        if($exe_6_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_2_masuk ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_2_masuk ...".PHP_EOL;
        }
        if($exe_6_1){
        ...
        // 7
        $exe_7_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_2_masuk_sekolah");
        ...
        if($exe_7_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_2_masuk_sekolah ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_2_masuk_sekolah ...".PHP_EOL;
        }
        if($exe_7_1){
        ...
        // 8
        $exe_8_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_2_masuk_sekolah_diambil");
        ...
        if($exe_8_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_2_masuk_sekolah_diambil ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_2_masuk_sekolah_diambil ...".PHP_EOL;
        }
        if($exe_8_1){
        ...
        // 10
        $exe_10_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.sisa_kuota_tahap_2");
        $exe_10_1 = DB::connection('sqlsrv_2')->statement("SELECT
                                                            ...
                                                            (CASE 
                                                                    ...
                                                                    WHEN rekap.peringkat_ppdb_tahap_1_2.jalur_id IN ('0300','0500') THEN kuota.kuota_0300
        ...
        if($exe_10_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.sisa_kuota_tahap_2 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.sisa_kuota_tahap_2 ...".PHP_EOL;
        }
        if($exe_10_1){
        ...
        // 11
        $exe_11_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_3_masuk");
        ...
        if($exe_11_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_3_masuk ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_3_masuk ...".PHP_EOL;
        }
        if($exe_11_1){
        ...
        // 12
        $exe_12_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_3_masuk_sekolah");
        ...
        if($exe_12_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_3_masuk_sekolah ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_3_masuk_sekolah ...".PHP_EOL;
        }
        if($exe_12_1){
        ...
        // 13
        $exe_13_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_3_masuk_sekolah_diambil");
        ...
        if($exe_13_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_3_masuk_sekolah_diambil ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_3_masuk_sekolah_diambil ...".PHP_EOL;
        }
        if($exe_13_1){
        ...
        // 15
        $exe_15_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.sisa_kuota_tahap_3");
        ...
        if($exe_15_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.sisa_kuota_tahap_3 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.sisa_kuota_tahap_3 ...".PHP_EOL;
        }
        if($exe_15_1){
        ...
        // 16
        $exe_16_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_4_masuk");
        ...
        if($exe_16_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_4_masuk ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_4_masuk ...".PHP_EOL;
        }
        if($exe_16_1){
        ...
        // 17
        $exe_17_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_4_masuk_sekolah");
        ...
        if($exe_17_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_4_masuk_sekolah ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_4_masuk_sekolah ...".PHP_EOL;
        }
        if($exe_17_1){
        ...
        // 18
        $exe_18_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_4_masuk_sekolah_diambil");
        ...
        if($exe_18_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_4_masuk_sekolah_diambil ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_4_masuk_sekolah_diambil ...".PHP_EOL;
        }
        if($exe_18_1){
        ...
        // 20
        $exe_20_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.sisa_kuota_tahap_4");
        ...
        if($exe_20_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.sisa_kuota_tahap_4 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.sisa_kuota_tahap_4 ...".PHP_EOL;
        }
        if($exe_20_1){
        ...
        // 21
        $exe_21_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_5_masuk");
        ...
        if($exe_21_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_5_masuk ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_5_masuk ...".PHP_EOL;
        }
        if($exe_21_1){
        ...
        // 22
        $exe_22_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_5_masuk_sekolah");
        ...
        if($exe_22_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_5_masuk_sekolah ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_5_masuk_sekolah ...".PHP_EOL;
        }
        if($exe_22_1){
        ...
        // 23
        $exe_23_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.peringkat_ppdb_tahap_5_masuk_sekolah_diambil");
        ...
        if($exe_23_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.peringkat_ppdb_tahap_5_masuk_sekolah_diambil ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.peringkat_ppdb_tahap_5_masuk_sekolah_diambil ...".PHP_EOL;
        }
        if($exe_23_1){
        ...
        // 25
        $exe_25_0 = DB::connection('sqlsrv_2')->statement("DROP TABLE rekap.sisa_kuota_tahap_5");
        ...
        if($exe_25_0){
            echo "[".date('Y-m-d H:i:s')."] [BERHASIL] DROP table rekap.sisa_kuota_tahap_5 ...".PHP_EOL;
        }else{
            echo "[".date('Y-m-d H:i:s')."] [GAGAL] DROP table rekap.sisa_kuota_tahap_5 ...".PHP_EOL;
        }
        if($exe_25_1){
