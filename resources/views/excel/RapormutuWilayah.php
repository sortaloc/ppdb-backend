...
->setCellValue('A1', 'Verifikasi Rapor Mutu '.$detail->nama.'')
->setCellValue('G3', 'Rapor Mutu '.$detail->nama.'')
...
header('Content-Disposition: attachment;filename="Verval Rapor Mutu '.$detail->nama.'.xlsx"');
