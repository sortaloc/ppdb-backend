...
$object->getActiveSheet()->getColumnDimension('M')->setWidth(14);
...
//set margeCell
$object->getActiveSheet()->mergeCells('B1:M1');
...
->setCellValue('I'.$headerTable, 'Dipilih')
->setCellValue('J'.$headerTable, 'Tanggal Disetujui')
->setCellValue('K'.$headerTable, 'Status')
->setCellValue('L'.$headerTable, 'Orangtua')
->setCellValue('M'.$headerTable, 'Kontak Orangtua')
;
...
foreach ($datalist as $value) {
  ...
  $ex->setCellValue("D".$num, $value->urutan_diambil);
  ...
  $ex->setCellValue("I".$num, $value->urut_dipilih);
...
header('Content-Disposition: attachment;filename="CalonPDB_Terima_2020_.xlsx"');
